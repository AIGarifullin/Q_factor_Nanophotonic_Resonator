...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', type=float, default=0.28, help='hole radius (default: 0.28*a um)')
    parser.add_argument('-hh', type=float, default=0.22, help='waveguide height (default: 0.22 um)')
    parser.add_argument('-w', type=float, default=2.30, help='waveguide width (default: 2.30 um)')
