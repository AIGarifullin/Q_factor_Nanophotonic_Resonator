...
#    Q. Quan, and M. Loncar
#    "Deterministic design of wavelength scale,
#     ultra-high Q photonic crystal nanobeam
#     cavities" Opt. Express, 19 (19), 18529-18542 (2011). 
...
def main(args):
    ...
    N_add = args.N_add # number of holes on either side of the center (10)
